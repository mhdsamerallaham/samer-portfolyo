...
import { ArrowLeft, Check, HelpCircle, ArrowUpRight, Award, HelpCircle as HelpIcon } from 'lucide-react';
  ...
  return (
    <div className="pt-32 pb-24 text-white min-h-screen text-left">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12">
        ...
        <Link
          to="/hizmetler"
          className="inline-flex items-center gap-2 text-xs font-black mono text-neutral-400 hover:text-[#00ffaa] mb-12 transition-colors"
        >
          <ArrowLeft size={14} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-white/5 mb-16 items-start">
          ...
          <div className="lg:col-span-4 bg-[#0a0a0a] border border-white/5 rounded-3xl p-6 flex flex-col gap-6 w-full mt-2 lg:mt-0">
            <h3 className="mono text-[9px] font-black text-[#00ffaa] tracking-wider uppercase">// SERVICE_INCLUDES</h3>
            <ul className="flex flex-col gap-3">
              {data.features.map((feature, i) => (
                <li key={i} className="flex gap-2.5 text-xs text-neutral-300 font-semibold leading-relaxed">
                  <Check size={14} className="text-[#00ffaa] flex-shrink-0 mt-0.5" />
                  <span>{feature}</span>
                </li>
              ))}
            </ul>
            <Link
              ...
              className="w-full py-4 bg-[#00ffaa] text-black text-center rounded-2xl mono text-[10px] font-black tracking-widest uppercase hover:scale-102 transition-all flex items-center justify-center gap-2 mt-4"
            >
        ...
        {data.ai_desc && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-lg md:text-xl font-black text-white flex items-center gap-2">
                  <span className="mono text-xs text-[#00ffaa]">// 01</span>
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-lg md:text-xl font-black text-white flex items-center gap-2">
                  <span className="mono text-xs text-[#00ffaa]">// 02</span>
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-lg md:text-xl font-black text-white flex items-center gap-2">
                  <span className="mono text-xs text-[#00ffaa]">// 03</span>
            ...
            <div className="lg:col-span-5 flex flex-col gap-6 bg-[#0a0a0a] border border-white/5 rounded-3xl p-8 relative overflow-hidden h-fit">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#00ffaa]/5 rounded-full blur-[40px] pointer-events-none" />
              <div className="w-10 h-10 rounded-xl bg-[#00ffaa]/10 flex items-center justify-center text-[#00ffaa] mb-2">
                <Award size={20} />
              </div>
              <h3 className="mono text-[10px] font-black text-white tracking-widest uppercase">// EX_PROJECT_CASE</h3>
